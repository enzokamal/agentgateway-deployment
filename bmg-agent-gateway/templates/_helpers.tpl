...
{{- define "bmg-agent-gateway.bmgUi.bmgApi" -}}
{{- default (printf "http://%s.%s.svc.cluster.local:%d" .Values.bmgAgent.service.name (include "bmg-agent-gateway.namespace" .) .Values.bmgAgent.service.port) .Values.bmgUi.deployment.env.bmgApi }}
{{- end }}
